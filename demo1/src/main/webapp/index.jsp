        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="ok-nav-item ok-hide-md">
                <div class="weather-ok">
                    <iframe frameborder="0" scrolling="no" class="iframe-style" src="${pageContext.request.contextPath}/page/weather.html" frameborder="0"></iframe>
                </div>
            </li>
        ...
        <div class="layui-side-scroll okadmin-side">
            ...
            <ul id="navBar" class="layui-nav okadmin-nav okadmin-bg-20222A layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:" lay-id="1" data-url="/system/console">
        ...
        <div class="layui-tab ok-tab" lay-filter="ok-tab" lay-allowClose="true" lay-unauto>
            ...
            <div id="tabContent" class="layui-tab-content ok-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe src='${pageContext.request.contextPath}/system/console' frameborder="0" scrolling="yes" width="100%"
                            height="100%"></iframe>
                </div>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/static/js/okadmin.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath}/static/lib/loading/okLoading.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>
